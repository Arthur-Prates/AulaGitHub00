...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-3 col-md-12 col-md-12"></div>
        <div class="col-lg-6 col-md-12 col-md-12">
            <div class=" mt-5 pb-5 mb-5 pt-5">
                <div class="container text-white">

                    <div class="card text-white tamanho" style="background:#0f0f0f;">
                        <div class="card-body text-center">
                            <div class="position-absolute top-50 start-50 translate-middle">
                                <h2>Senha incorreta!</h2>
                                <br>
                                <a href="login.php" type="button" class="btn btn-outline-light">Voltar</a>
                            </div>
                        </div>
                    </div>
